...
module.exports = function (config) {
  ...
  config.addFilter('i18nContent', function (relations, i18nContent) {
  ...
  config.addFilter('sortBy', function(collection, field){
    return collection.sort((a, b) => a.data[field] - b.data[field])
  })
